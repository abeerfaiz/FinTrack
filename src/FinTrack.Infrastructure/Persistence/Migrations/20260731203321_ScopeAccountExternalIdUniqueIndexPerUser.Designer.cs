...
namespace FinTrack.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260731203321_ScopeAccountExternalIdUniqueIndexPerUser")]
    partial class ScopeAccountExternalIdUniqueIndexPerUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinTrack.Domain.Entities.Account", b =>
                {
                    ...
                    b.HasIndex("ExternalAccountId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_accounts_external_account_id_user_id");
